...
% Grade Description
\newcommand{\GradeDesc}{
Your grade is determined by your performance on quizzes, a midterm, and
...
% Makeup Policy
\newcommand{\MakeUp}{
Missed assessments may be excused per the below attendance policy. Excused
quizzes are replaced with the next taken quiz grade; a makeup for the midterm
must be scheduled and taken within a week of the excused absence.
}
...
Photo ID may be required at examinations.

Any student who
disrupts class will be asked to leave and will be marked as absent.
}
...
who enter after roll is called are marked as absent.
...
for the absence to be considered excused. The final exam will only be
excused in case of a major medical emergency.

\textbf{Homework and Quizzes:} \\
...
hours. Quizzes will be given roughly weekly based upon homework problems.
...
\textbf{Calculators:} \\
Calculators with features equal to or less than a TI-89
are allowed in tests and final exams, but are never required.
However, you must show work which is followable without the use of any
calculator.

\textbf{Open-note policy:} \\
Notes may be used on quizzes.
Students may use up to three \(8.5\times 11\) inch sheets of paper (front
and back) for notes
to use on the midterm. Six sheets are allowed for the final.
