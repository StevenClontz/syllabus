...
Students may use any notes they wish while presenting, except for the
textbook (to prevent blindly rewriting the given proof).

When called, the student may choose to not present if they are not prepared
(or absent) at most twice during the semester; otherwise they will be
assigned a \(30\) for that presentation. Otherwise, a grade
